...
function Footer() {
  return (
    <Box sx={{
        ...
        <Box sx={{
            display: 'flex',
            gap: {xs: '70px', md: '150px'},
            order: {xs: '2', md: '2'}
        }}>
            <ul style={{listStyleType: 'none', fontWeight: 400}}>
                <li style={{ padding: '5px 0px', fontSize: '12px'}}>Home</li>
                <li style={{ padding: '5px 0px', fontSize: '12px'}}>Pricing</li>
                <li style={{ padding: '5px 0px', fontSize: '12px'}}>Products</li>
                <li style={{ padding: '5px 0px', fontSize: '12px'}}>About Us</li>
            </ul>
            <ul style={{listStyleType: 'none'}}>
                <li style={{ padding: '5px 0px', fontSize: '12px'}}>Careers</li>
                <li style={{ padding: '5px 0px', fontSize: '12px'}}>Community</li>
                <li style={{ padding: '5px 0px', fontSize: '12px'}}>Privacy Policy</li>
            </ul>
        </Box>
        <Box sx={{
            display: 'flex',
           ...
           <div>
            ...
            />
            <CustomButton style={{marginLeft: '10px'}}>Go</CustomButton>
            </div>
            <div>
